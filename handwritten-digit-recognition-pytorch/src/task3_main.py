...
def main(argv):
    ...
    create_dataset('../greek_data', '../csvfile/dataset.csv', '../csvfile/label.csv')
    ...
    dataset, label = read_dataset('../csvfile/dataset.csv', '../csvfile/label.csv')
    dataset_y = change_datatype(dataset)
    Greek_submodel.eval()
    with torch.no_grad():
        output_greek = Greek_submodel(dataset_y)
        print("------------------------------------------------------------------------------------")
        print("The element vectors has size of: ", output_greek.shape)
        print(output_greek)
        print("------------------------------------------------------------------------------------")
    ...
    input_image,raw_img = get_new_greekdata('..\greek_input')
